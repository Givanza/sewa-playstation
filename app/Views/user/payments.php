      ...
      <div class="row" style="justify-content: center;">
        <div class="col-lg-4">
          <div class="card">
            <form action="">
              <div class="card-body">
                <h5 class="card-title" align="center">Payments With</h5>
                <table class="table border-dark">
                  <tbody>
                    <tr>
                      <th scope="row"><img src="img/dana.png" alt="" style="width: 100px; height:auto;"></th>
                      <td valign="middle"><input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option1" checked=""></td>
                    </tr>
                    <tr>
                      <th scope="row"><img src="img/cod.png" alt="" style="width: 100px; height:auto;"></th>
                      <td valign="middle"><input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option2" checked=""></td>
                    </tr>
                    <tr>
                      <th scope="row"><img src="img/bni.png" alt="" style="width: 100px; height:auto;"></th>
                      <td valign="middle"><input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option3" checked=""></td>
                    </tr>
                  </tbody>
                </table>
                <div class="col-12">
